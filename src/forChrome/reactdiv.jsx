...
class FullDiv extends React.Component {
  ...
  doFPress(thisRef) {
    ...
    for (let i = 0; i <= thisRef.state.quantity; i++) { // eslint-disable-line no-plusplus
      setTimeout(this.pressF, i * thisRef.state.quality);
    }
  }
  pressF() { // eslint-disable-line class-methods-use-this
    rj.keyTap('f');
  }
  render() {
    return (
...
const reactdiv = document.getElementById('reactdiv'); // eslint-disable-line no-undef
